...
export default function QualityPage() {
  ...
  return (
    <PageShell title={t(filters.language, "page_quality_title")} subtitle="Data quality scoring and investigations">
