...
function AdminNavTabs({ fr }: { fr: boolean }) {
  const tabs = [
    { href: "/admin/users", label: fr ? "Responsables" : "Responsibles", active: true },
    { href: "/admin/security", label: "Security Center", active: false },
  ];
  return (
    <nav
