...
/** Accent polygonal discret pour les pages applicatives. */
export function PlatformPolyAccent() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,#fff7f7_0%,#f8fafc_42%,#f1f5f9_100%)]" />
      <svg
        className="absolute -right-[12%] -top-[8%] h-[min(72vh,680px)] w-[min(90vw,920px)] opacity-[0.14]"
        viewBox="0 0 1440 900"
        preserveAspectRatio="xMidYMid slice"
        xmlns="http://www.w3.org/2000/svg"
      >
        <polygon points="520,0 1440,0 1440,260 720,180" fill="#ed1c24" />
        <polygon points="720,180 1440,260 1440,620 1100,520" fill="#c41e24" />
        <polygon points="1100,520 1440,620 1440,900 620,900" fill="#b51218" />
        <polygon points="280,420 720,180 1100,520 420,900" fill="#d91f28" />
      </svg>
      <div className="absolute bottom-0 left-0 h-40 w-full bg-gradient-to-t from-red-50/40 to-transparent" />
    </div>
  );
}
