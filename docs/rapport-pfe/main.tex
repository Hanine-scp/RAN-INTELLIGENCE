...
\begin{longtable}{|p{1.2cm}|p{7.2cm}|p{1.4cm}|p{2.8cm}|p{1.4cm}|}%
\hline\rowcolor[RGB]{220,0,0}\color{white}\textbf{ID}&\color{white}\textbf{User Story}&\color{white}\textbf{Priorité}&\color{white}\textbf{Statut}&\color{white}\textbf{Points}\\\hline\endhead
#1\hline\end{longtable}\caption{\textbf{#2}}}
...
\begin{longtable}{|p{1.1cm}|p{7.4cm}|p{1.5cm}|p{2.6cm}|}
\hline\rowcolor[RGB]{220,0,0}\color{white}\textbf{ID}&\color{white}\textbf{User Story}&\color{white}\textbf{Priorité}&\color{white}\textbf{Sprint}\\\hline
US-01 & Authentification JWT et MFA entreprise & Haute & Sprint 1 \\\hline
US-02 & Bootstrap administrateur sécurisé & Haute & Sprint 1 \\\hline
US-03 & Pipeline XML $\rightarrow$ Parquet & Haute & Sprint 2 \\\hline
US-04 & Upload admin et registre bronze & Haute & Sprint 2 \\\hline
US-05 & Dashboard exécutif et filtres globaux & Haute & Sprint 3 \\\hline
US-06 & Sites, inventaire, assets, qualité & Haute & Sprint 3 \\\hline
US-07 & Module Delta et remplacements & Moyenne & Sprint 3 \\\hline
US-08 & Moteurs Guardian (4 engines) & Haute & Sprint 4 \\\hline
US-09 & Anomalies, cartes risque, patterns & Moyenne & Sprint 4 \\\hline
US-10 & Assistant IA contrôlé + RAG & Haute & Sprint 5 \\\hline
US-11 & Docker, CI/CD, observabilité & Moyenne & Sprint 5 \\\hline
\caption{\textbf{Product Backlog priorisé}}
